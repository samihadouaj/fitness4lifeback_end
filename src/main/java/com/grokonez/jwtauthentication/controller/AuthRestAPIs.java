...
//    RoleRepository roleRepository;
    ...
    public String check(@Valid @RequestBody SignUpForm signUpRequest) {
    ...
    public ResponseEntity<String> registerUser(@Valid @RequestBody SignUpForm signUpRequest) {
        ...
        User user = new User(signUpRequest.getFirstName(), signUpRequest.getLastName(),
                ...
                signUpRequest.getCurrent_weight(),
                signUpRequest.getHigh(),
                signUpRequest.getTarget_weight(),
                signUpRequest.getActivity_lvl(),
                signUpRequest.getDiet_pace(),
